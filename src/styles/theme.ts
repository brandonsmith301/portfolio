export const theme = {
  light: {
    ...
    text: {
      ...
      secondary: '#4A4947',  // Used for body text and descriptions
    ...
    nav: {
      ...
      bubble: '#DBD9D5',                // Used for Spotify tab buttons and nav indicators
  ...
  dark: {
    ...
    nav: {
      ...
      bubble: '#363636',          // Used for nav indicators
